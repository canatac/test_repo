...
public class Alignments extends TouchLayout {

    public Alignments() {

        setCaption("Component alignment");

        addComponent(new Label(
                "GridLayout, VerticalLayout, and HorizontalLayout, "
                        + "which are tabular layouts consisting of cells, support "
                        + "alignment of components within the layout cells. The alignment "
                        + "of a component within its respective cell is set with "
