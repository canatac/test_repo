...
public class VAcceptCriterionFactoryImpl extends com.vaadin.terminal.gwt.client.ui.dd.VAcceptCriterionFactory {
  public VAcceptCriterion get(String name) {
    name = name.intern();
    if ("com.vaadin.event.dd.acceptcriteria.Or" == name) return GWT.create(com.vaadin.terminal.gwt.client.ui.dd.VOr.class );
    ...
    else if ("com.vaadin.event.dd.acceptcriteria.SourceIsTarget" == name) return GWT.create(com.vaadin.terminal.gwt.client.ui.dd.VSourceIsTarget.class );
