...
public class WidgetMapImpl extends com.vaadin.terminal.gwt.client.WidgetMap {
  public Class<? extends Paintable> getImplementationByServerSideClassName(String fullyQualifiedName) {
    ...
    if ( fullyQualifiedName == "com.vaadin.ui.Window" ) { ensureInstantiator(com.vaadin.terminal.gwt.client.ui.VWindow.class); return com.vaadin.terminal.gwt.client.ui.VWindow.class;}
    ...
    else if ( fullyQualifiedName == "com.ortens.TouchLayout" ) { ensureInstantiator(com.ortens.widgetset.client.ui.VTouchLayout.class); return com.ortens.widgetset.client.ui.VTouchLayout.class;}
    ...
    else if ( fullyQualifiedName == "com.ortens.TouchMenu" ) { ensureInstantiator(com.ortens.widgetset.client.ui.VTouchMenu.class); return com.ortens.widgetset.client.ui.VTouchMenu.class;}
    else if ( fullyQualifiedName == "com.ortens.TouchPanel" ) { ensureInstantiator(com.ortens.widgetset.client.ui.VTouchPanel.class); return com.ortens.widgetset.client.ui.VTouchPanel.class;}
    else if ( fullyQualifiedName == "com.vaadin.addon.touchkit.ui.SwipeView" ) { ensureInstantiator(com.vaadin.addon.touchkit.gwt.client.VSwipeView.class); return com.vaadin.addon.touchkit.gwt.client.VSwipeView.class;}
  ...
  if( classType == com.vaadin.terminal.gwt.client.ui.VWindow.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
...
} else if( classType == com.vaadin.terminal.gwt.client.ui.VVideo.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(com.vaadin.terminal.gwt.client.ui.VVideo.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(com.vaadin.terminal.gwt.client.ui.VVideo.class );
  }
  }
  );}});
} else if( classType == com.ortens.widgetset.client.ui.VTouchLayout.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(com.ortens.widgetset.client.ui.VTouchLayout.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(com.ortens.widgetset.client.ui.VTouchLayout.class );
  }
  }
  );}});
...
} else if( classType == com.vaadin.terminal.gwt.client.ui.VUpload.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
...
} else if( classType == com.vaadin.terminal.gwt.client.ui.VAudio.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(com.vaadin.terminal.gwt.client.ui.VAudio.class,new WidgetInstantiator() {
   public Paintable get() {
...
} else if( classType == com.vaadin.terminal.gwt.client.ui.VTreeTable.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(com.vaadin.terminal.gwt.client.ui.VTreeTable.class,new WidgetInstantiator() {
   public Paintable get() {
...
} else if( classType == com.ortens.widgetset.client.ui.VTouchMenu.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(com.ortens.widgetset.client.ui.VTouchMenu.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(com.ortens.widgetset.client.ui.VTouchMenu.class );
  }
  }
  );}});
} else if( classType == com.ortens.widgetset.client.ui.VTouchPanel.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(com.ortens.widgetset.client.ui.VTouchPanel.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(com.ortens.widgetset.client.ui.VTouchPanel.class );
  }
  }
  );}});
} else if( classType == com.vaadin.addon.touchkit.gwt.client.VSwipeView.class) {instmap.put(com.vaadin.addon.touchkit.gwt.client.VSwipeView.class, new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(com.vaadin.addon.touchkit.gwt.client.VSwipeView.class );
  }
  }
