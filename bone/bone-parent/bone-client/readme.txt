 ...
 automatically using the #{dataStatus} attribute which appears in the template 
 ...
 and put data aware expressions ahead of the #{dataStatus} expression, then the
...
{project.artifactId}lhost:8080/${project.artifactId}/home.xhtml
 ...
 The expression #{books} is used to refer to the list of books and the producer
