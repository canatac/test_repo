...
public class ChangementPersistenceUseCasesTest {
	public static Logger _logger = Logger
			.getLogger(ChangementPersistenceUseCasesTest.class.getName());
	...
	protected static final String[] CHANGEMENT_TITLES = { "Correction", "Evolution", 
		"TestChangement4", "TestChangement3" };
